...
export const EVENT_DETAILS = {
  ...
  'tug-o-war': {
    ...
    rules: [
      ...
      'Team Composition: Maximum 2 substitutes.',
      'Match Format: Best of 3 rounds.',
      'Match Format: 2 minutes per round.',
      'Match Format: 1 minute break between rounds.',
      'Winning Criteria: Pull the opponent team past the boundary line.',
      'Winning Criteria: Win 2 rounds to win the match.',
      "Start Signal: Match starts only on referee’s command.",
      'Start Signal: Early pull = foul.',
      'Footwear & Safety: Sports shoes compulsory.',
      'Footwear & Safety: Gloves allowed (no sticky substances).',
