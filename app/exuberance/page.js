...
import ExuberanceResponsiveNav from './ExuberanceResponsiveNav.jsx';
  ...
  return (
    <div className={styles.wrap}>
      ...
      <div
        className="bg"
        style={{
          backgroundImage: 'url("/background/mainpage_bg.jfif")',
      ...
      <header className="topbar">
        <Link className="brand" href="/" aria-label="TINT Home">
          <span className="brand__mark" aria-hidden="true">
            <img src="/logos/exuberance_logo.webp" alt="" width="46" height="46" />
          </span>
        ...
        <ExuberanceResponsiveNav styles={styles} />
      </header>
