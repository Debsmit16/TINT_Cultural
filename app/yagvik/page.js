...
export const metadata = {
  title: 'Yagvik | Coming Soon | TINTWeb',
  description: 'Yagvik — Annual Cultural Fest. Coming Soon.',
};

export default function YagvikPage() {
  return (
    <div className={styles.wrap}>
      ...
      <main className={styles.main}>
        <div className={styles.content}>
          ...
          <h1 className={styles.title}>Yagvik</h1>
          <p className={styles.subtitle}>Annual Cultural Fest</p>
          <div className={styles.badge}>Coming Soon</div>
          <p className={styles.desc}>
            Music, lights, and timeless performances — curated chaos that feels elegant.
          </p>
